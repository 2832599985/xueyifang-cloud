...
- `xueyifang-service` 已接入 `service`、`service_image`、`service_tag`、`service_favorite` 和 `service_review` 表，提供服务列表、详情、标签读取、服务发布、我的服务、编辑、上下架、逻辑删除、收藏、我的收藏、评价列表和订单评价状态接口。
